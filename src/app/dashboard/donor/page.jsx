...
//     // ২. কোন ৩-ডট ড্রপডাউনটি ওপেন আছে তা ট্র্যাক করার স্টেট (ID স্টোর করবে)
//     const [activeDropdown, setActiveDropdown] = useState(null);

//     // ৩. মক ডাটা (Fake Data) - ৩টি সাম্প্রতিক রিকোয়েস্ট
...
//             donor: { name: "Anisur Rahman", email: "anis@email.com" }
//         },
//         {
//             id: "req-102",
...
//     // ৪. স্ট্যাটাস পরিবর্তন করার হ্যান্ডলার (Done / Cancel)
...
//     // ৫. ডিলিট করার হ্যান্ডলার (Confirmation Modal সহ)
//     const handleDelete = (id) => {
//         const isConfirmed = window.confirm("Are you sure you want to delete this donation request?");
//         if (isConfirmed) {
...
//                 </h1>
//                 <p className="text-gray-600 mt-1">Manage your blood donation requests from here.</p>
//             </div>

//             {/* --- RECENT REQUESTS SECTION --- */}
//             {/* রিকোয়েস্ট থাকলেই কেবল এই পুরো সেকশনটি দেখাবে, না থাকলে হাইড থাকবে */}
//             {requests.length > 0 && (
...
//                                             <div className="text-xs text-gray-400">{request.time}</div>
//                                         </td>
...
//                                         {/* ৫. Donation Status */}
//                                         <td className="p-4">
//                                             <span className={`capitalize px-2.5 py-1 rounded-full font-medium text-xs ${request.status === 'done' ? 'bg-green-100 text-green-800' :
//                                                     request.status === 'canceled' ? 'bg-gray-100 text-gray-600' :
...
//                                         {/* ৬. Donor Info (Show only if status is 'inprogress') */}
//                                         <td className="p-4 text-sm">
//                                             {request.status === 'inprogress' && request.donor ? (
//                                                 <div>
//                                                     <p className="font-semibold text-gray-700">{request.donor.name}</p>
//                                                     <p className="text-gray-500 text-xs">{request.donor.email}</p>
//                                                 </div>
//                                             ) : (
...
//                                         {/* ৭. Actions Column (৩-ডট ড্রপডাউন মেনু) */}
...
//                                                 <div className="absolute right-4 top-12 z-10 mt-2 w-44 rounded-xl border border-gray-200 bg-white shadow-lg">
//                                                     <button
//                                                         onClick={() => {
